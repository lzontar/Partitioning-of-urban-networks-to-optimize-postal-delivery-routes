...
from util.lib.helper import geo_distance

parser = argparse.ArgumentParser(
    description='Simple script that generates city infrastructure graph')

parser.add_argument('-n', '--naselje',
                    type=str,
                    default=None,
                    help='name of settlement'
                    )

parser.add_argument('-o', '--obcina',
                    type=str,
                    default='Tolmin',
                    help='name of municipality'
                    )

parser.add_argument('-g',
                    action='store_true',
                    help='flag to generate graph')

parser.add_argument('-e',
                    action='store_true',
                    help='flag to generate Excel file')

if __name__ == '__main__':
    args = parser.parse_args()

    naselje = args.naselje
    obcina = args.obcina
    ...
    generate_graph = args.g
    zgeneriraj_csv = args.e

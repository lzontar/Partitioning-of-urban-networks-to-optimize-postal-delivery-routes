...
if __name__ == '__main__':
    ...
    nx.write_pajek(g, f'{args.path[:-4]}-kcut_weighted_nodes.net')
    ...
    nx.write_pajek(g, f'{args.path[:-4]}-kcut_edge_distance.net')
    ...
    nx.write_pajek(g, f'{args.path[:-4]}-kcut_edge_duration.net')